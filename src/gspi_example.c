...
/* WiFi auto-on timeout in milliseconds (60 seconds like upstream ELRS) */
...
void elrs_cpp_task(void *argument) {
  ...
  while (1) {
     ...
     * Citation: ExpressLRS rx_main.cpp GotConnection() sets
    ...
    /* WiFi auto-on timeout check (60 seconds)
     * Citation: ExpressLRS devWIFI.cpp WifiService()
     *   If no connection after wifi_auto_on_interval, enter WiFi mode
     */
    ...
    /* Check WiFi mode request flag (set by button callback or auto-timeout) */
